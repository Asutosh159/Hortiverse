...
/* ══════════════════════════════════════════════════════════
   MAIN — compact claymorphism register (matching Login)
══════════════════════════════════════════════════════════ */
export default function Register() {
  const navigate = useNavigate();
  ...
  // accent color for clay card (matches Login)
  const accent = "#2A9D8F"; // teal
    ...
    <>
      <style>{`
        ...
        * {
        ...
        /* === MODERN CLAYMORPHISM BACKGROUND === */
        .clay-bg {
          position: fixed;
          inset: 0;
          background: #0f172a;
        ...
        .clay-card {
          ...
          border-radius: 40px;
          padding: 1.5rem 1.5rem;            /* 🔹 reduced from 2.2rem */
          box-shadow:
        ...
        .input-wrapper {
          ...
          border-radius: 28px;                  /* 🔹 slightly smaller */
        ...
        /* === ROLE BUTTONS — more compact grid === */
        .role-grid {
          display: flex;
          gap: 6px;
          flex-wrap: wrap;
        ...
        .role-btn.on {
          background: ${accent};
          color: white;
          box-shadow: 0 8px 16px -8px ${accent}80, inset 0 2px 4px rgba(255,255,255,0.3);
        }
        .role-btn:hover {
        ...
        .step-circle.done {
          background: ${accent};
          color: white;
          box-shadow: 0 8px 16px -8px ${accent}80;
        }
        .step-label {
          font-size: 0.55rem;
          text-transform: uppercase;
        ...
        .progress-fill {
          ...
          background: ${accent};
          width: 0%;
          animation: progress 2.6s ease forwards;
        }
        @keyframes progress {
          to { width: 100%; }
        }

        /* === CHECKBOX (clay) — compact === */
        .clay-checkbox {
          display: flex;
        ...
        .checkbox-custom.checked {
          background: ${accent};
          box-shadow: 0 4px 8px -4px ${accent}80;
        }
          ...
          {success ? (
            <div className="success-container">
              ...
              <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.8rem' }}>
                Your account is ready. Redirecting home...
              </p>
              ...
              {step === 1 && (
                <div className="fade-step">
                  ...
                  <div className="input-group">
                    ...
                    {emailOk === false && (
                      <p style={{ color: '#f28482', fontSize: '0.65rem', marginTop: 2 }}>Email already registered.</p>
                    )}
                  </div>
